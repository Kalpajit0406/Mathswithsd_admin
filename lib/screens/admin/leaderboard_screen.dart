...
class _RankCard extends StatelessWidget {
  ...
  Widget _statusIndicator(bool isSecure, String text) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(
            isSecure ? Icons.check_circle_outline : Icons.error_outline,
            color: color,
            size: 14,
          ),
  ...
  Widget build(BuildContext context) {
    ...
    final bool hasAlerts =
        isAutoSubmitted || violations.isNotEmpty || emulator || root;
                  ...
                  if (hasAlerts) ...[
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        if (root) _badge('Rooted', Colors.red.shade700),
                        if (emulator)
